# 모바일 앱에 GA4(Firebase Analytics) 세팅 시 필수 고려 사항 가이드

Source: https://osoma.kr/blog/firebase-setting-essential-consider-guide/
...
![Firebase Analytics와 GA4](https://osoma.kr/images/posts/firebase-setting-essential-consider-guide/01.png)
...
> [Firebase Analytics와 GA4의 관계 알아보기](https://osoma.kr/blog/ga4-firebase/)
...
![네이티브 및 웹뷰(하이브리드 앱) 방식 확인](https://osoma.kr/images/posts/firebase-setting-essential-consider-guide/02.png)
...
리액트 네이티브 앱에 Firebase Analytics를 사용하려면 구글에서 공식적으로 제공하는 방식이 없기 때문에 [React Native Firebase](https://rnfirebase.io/)의 `@react-native-firebase/analytics` 패키지를 사용해야 합니다.

### 플러터(Flutter)

플러터에서 Firebase Analytics를 사용하려면 [구글에서 공식적으로 제공](https://pub.dev/packages/firebase_analytics)하는 `firebase_analytics` 패키지를 사용해 세팅을 진행합니다.
...
> [Disable screenview tracking - Google Analytics for Firebase](https://firebase.google.com/docs/analytics/screenviews#disable_screenview_tracking)

### 수동 화면 추적

앱의 특정 화면을 더 세밀하게 추적하거나 자동 추적 기능을 사용하지 않는 경우 수동으로 화면 전환을 설정할 수 있습니다. 수동 추적을 사용하는 방법은 아래 링크를 참고하세요.

> [Manually track screens - Google Analytics for Firebase](https://firebase.google.com/docs/analytics/screenviews#manually_track_screens)
...
![이벤트 이름 표준화](https://osoma.kr/images/posts/firebase-setting-essential-consider-guide/03.png)
...
![웹사이트와 GA4 속성 통합](https://osoma.kr/images/posts/firebase-setting-essential-consider-guide/04.png)
