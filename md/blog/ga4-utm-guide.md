# 구글 애널리틱스 4(GA4) 사용자를 위한 UTM 실전 가이드

Source: https://osoma.kr/blog/ga4-utm-guide/
...
<div class="gallery-box">
  <div class="gallery">
    <img src="https://osoma.kr/images/posts/ga4-utm-guide/01.png" alt="이미지 출처: 물류신문">
  </div>
  <em>이미지 출처: 물류신문</em>
</div>
...
![URL 구조](https://osoma.kr/images/posts/ga4-utm-guide/02.png)
...
<div class="gallery-box">
  <div class="gallery">
    <img src="https://osoma.kr/images/posts/ga4-utm-guide/03.png" alt="쇼핑몰에서 흔히 볼 수 있는 URL 구조">
  </div>
...
![UTM 사용처](https://osoma.kr/images/posts/ga4-utm-guide/05n.png)
...
![URL 빌더](https://osoma.kr/images/posts/ga4-utm-guide/06.png)

[▶ URL Builder 바로가기](https://ga-dev-tools.web.app/ga4/campaign-url-builder/)

엑셀이나 스프레드시트를 이용하면 더욱 편하게 UTM 정보를 관리할 수 있습니다. 아래 양식을 사용하여 사본을 생성하여 UTM을 관리해보세요.

![UTM 생성기](https://osoma.kr/images/posts/ga4-utm-guide/07.png)
...
```url
https://website.com?utm_source=&utm_medium=paid-social&utm_campaign=&utm_content=&utm_term=
```
