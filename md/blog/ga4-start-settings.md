# GA4 설치 후 바로 세팅해야 하는 5가지

Source: https://osoma.kr/blog/ga4-start-settings/
...
![데이터 수집](https://osoma.kr/images/posts/ga4-start-settings/01-1.png)

- 신호 데이터 활성화 내용을 확인하고 하단에 [계속] 버튼을 클릭합니다.

![데이터 수집](https://osoma.kr/images/posts/ga4-start-settings/01-2.png)

- 상세 설명을 확인하고 [활성화] 버튼을 클릭합니다.

![데이터 수집](https://osoma.kr/images/posts/ga4-start-settings/01-3.png)

- Google 신호 데이터 수집 토글 버튼이 파란색이 되었는지 확인합니다.

![데이터 수집](https://osoma.kr/images/posts/ga4-start-settings/01-4.png)

**[데이터 보관 기간 설정 경로]**
: 관리 > 속성 > 데이터 설정 > 데이터 보관 > 이벤트 데이터 보관 > 14개월 선택 > [저장]

![데이터 보관](https://osoma.kr/images/posts/ga4-start-settings/02.png)
...
![교차도메인](https://osoma.kr/images/posts/ga4-start-settings/03-1.png)

- 웹 스트림 세부정보 화면에서 [태그 설정 구성] 메뉴를 선택합니다.

![교차도메인](https://osoma.kr/images/posts/ga4-start-settings/03-2.png)

- 태그 설정 구성 메뉴내에서 [도메인 구성] 메뉴를 선택합니다.

![교차도메인](https://osoma.kr/images/posts/ga4-start-settings/03-3.png)

- 도메인 구성 메뉴 내 [조건추가] 버튼을 클릭합니다.

![교차도메인](https://osoma.kr/images/posts/ga4-start-settings/03-4.png)

- 도메인과 조건을 입력하고 [저장하기] 버튼을 누릅니다.

![교차도메인](https://osoma.kr/images/posts/ga4-start-settings/03-5.png)
...
![내부 트래픽](https://osoma.kr/images/posts/ga4-start-settings/04-1.png)

- 웹 스트림 세부정보 화면에서 [태그 설정 구성] 메뉴를 선택합니다.

![내부 트래픽](https://osoma.kr/images/posts/ga4-start-settings/04-2.png)

- 태그 설정 구성 메뉴 오른쪽에서 [모두 표시]를 선택해 메뉴 전체를 활성화 합니다.

![내부 트래픽](https://osoma.kr/images/posts/ga4-start-settings/04-3.png)

- 펼침 메뉴 중 5번째에 있는 [내부 트래픽 정의]를 선택합니다.

![내부 트래픽](https://osoma.kr/images/posts/ga4-start-settings/04-4.png)

- 내부 트래픽 정의 메뉴 내에서 [만들기] 버튼을 클릭합니다.

![내부 트래픽](https://osoma.kr/images/posts/ga4-start-settings/04-5.png)

- 내부 트래픽 규칙 만들기 화면에서 [IP 주소 조건]과 [값]을 입력하고, [만들기] 버튼을 클릭합니다.

![내부 트래픽](https://osoma.kr/images/posts/ga4-start-settings/04-6.png)

- 내부 트래픽 정의 목록에 저장된 내용을 확인합니다.

![내부 트래픽](https://osoma.kr/images/posts/ga4-start-settings/04-7.png)
...
![원치 않는 추천](https://osoma.kr/images/posts/ga4-start-settings/04-1.png)

- 웹 스트림 세부정보 화면에서 [태그 설정 구성] 메뉴를 선택합니다.

![원치 않는 추천](https://osoma.kr/images/posts/ga4-start-settings/04-2.png)

- 태그 설정 구성 메뉴 오른쪽에서 [모두 표시]를 선택해 메뉴 전체를 활성화 합니다.

![원치 않는 추천](https://osoma.kr/images/posts/ga4-start-settings/04-3.png)

- 펼침 메뉴 중 6번째에 있는 [원치 않는 추천 나열]을 선택합니다.

![원치 않는 추천](https://osoma.kr/images/posts/ga4-start-settings/05-1.png)

- 원치 않는 추천 나열 화면에서 [추천도메인 일치 조건]과 [도메인]을 입력하고 [저장하기] 버튼을 클릭합니다.

![원치 않는 추천](https://osoma.kr/images/posts/ga4-start-settings/05-2.png)
...
![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/06-1.png)

- 맞춤 설정 항목 최상단에 [크기] 메뉴를 선택합니다.

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/06-2.png)

- [측정기준 추가]를 선택합니다.

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/06-3.png)

- 첫번째 사용자 수동 검색어 / 첫번째 사용자 수동 광고 콘텐츠 항목을 추가합니다.

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/06-4.png)

- 적용 후 현재 보고서에 저장합니다.

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/06-5.png)

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/06-6.png)

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/06-7.png)

- [뒤로] 버튼을 눌러 보고서로 돌아가 항목이 추가되었는지 확인합니다.

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/06-8.png)

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/06-9.png)
...
![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/07-1.png)

- 맞춤 설정 항목 최상단에 [크기] 메뉴를 선택합니다.

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/07-2.png)

- [측정기준 추가]를 선택합니다.

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/07-3.png)

- 세션 수동 검색어, 세션 수동 광고 콘텐츠 추가

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/07-4.png)

- 적용 후 현재 보고서에 저장합니다.

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/07-5.png)

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/07-6.png)

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/07-7.png)

- [뒤로] 버튼을 눌러 보고서로 돌아가 항목이 추가되었는지 확인합니다.

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/07-8.png)

![UTM 항목](https://osoma.kr/images/posts/ga4-start-settings/07-9.png)
