# GA4 - BigQuery 연결: GA4 데이터를 빅쿼리에 저장하기

Source: https://osoma.kr/blog/ga4-bigquery-connect/
...
[Google Cloud \| BigQuery란 무엇인가요?](https://cloud.google.com/bigquery/docs/introduction?hl=ko)
...
- [데이터 기준점 적용](https://osoma.kr/blog/google-signal/)
- [GA4 API 할당량 이슈](https://osoma.kr/blog/looker-studio-ga-api-quota/)

그럼 이제, GA4의 데이터를 BigQuery에 적재할 수 있도록 BigQuery 계정을 생성하고 GA4와 BigQuery를 연결하는 방법을 알아보겠습니다.

## BigQuery 계정 만들기

1\. Google 계정 로그인 후, [빅쿼리 무료 계정 만들기](https://console.cloud.google.com/freetrial/signup/tos?hl=ko) 링크에 접속하여 빅쿼리 계정 생성을 시작합니다.

서비스 약관 동의 후 [계속] 버튼을 클릭합니다.

![가입](https://osoma.kr/images/posts/ga4-bigquery-connect/01.png)

2\. 고객 정보 입력 후 [계속] 버튼을 클릭합니다.

![결제 등록](https://osoma.kr/images/posts/ga4-bigquery-connect/02.png)

3\. 결제 정보 입력 후 [계속] 버튼을 클릭합니다.

![카드 등록](https://osoma.kr/images/posts/ga4-bigquery-connect/03.png)

4\. 결제 카드 번호 입력 후 [무료 평가판 시작하기] 버튼을 눌러 빅쿼리 계정 생성을 완료합니다.

![세무 정보](https://osoma.kr/images/posts/ga4-bigquery-connect/04.png)

5\. 빅쿼리 계정 생성 후 설문 응답 시 [완료]를, 응답을 원하지 않을 시 [닫기]를 클릭합니다.

![튜토리얼](https://osoma.kr/images/posts/ga4-bigquery-connect/05.png)

6\. 튜토리얼 진행을 원할 시 각 튜토리얼 진행, 별도 진행 원하지 않을 시 [건너뛰기] 버튼을 클릭합니다.

![튜토리얼 건너뛰기](https://osoma.kr/images/posts/ga4-bigquery-connect/06.png)

7\. 계정 생성 완료 후 기본 생성되는 프로젝트(My First Project) 클릭 후 나타나는 팝업 창 우측 상단 [새 프로젝트] 버튼 클릭합니다.

![새 프로젝트](https://osoma.kr/images/posts/ga4-bigquery-connect/07.png)

8\. 프로젝트 이름 설정 후 [만들기] 버튼을 클릭합니다.

![프로젝트 만들기](https://osoma.kr/images/posts/ga4-bigquery-connect/08.png)
...
![GA 링크](https://osoma.kr/images/posts/ga4-bigquery-connect/09n.png)

2\. 우측 상단 [연결] 버튼을 클릭합니다.

![GA 연결](https://osoma.kr/images/posts/ga4-bigquery-connect/10n.png)

3\. [BigQuery 프로젝트 선택하기] 버튼을 클릭합니다.

![프로젝트 선택하기](https://osoma.kr/images/posts/ga4-bigquery-connect/11.png)

4\. 연결하고자 하는 프로젝트 선택 후 [확인] 버튼을 눌러 연결합니다.

\* 하나의 GA 속성에는 하나의 빅쿼리 프로젝트만 연결할 수 있습니다.

![프로젝트 확인](https://osoma.kr/images/posts/ga4-bigquery-connect/12.png)

5\. 데이터 저장 위치를 선택합니다.

서비스가 운영되는 지역을 선택하는 것이 좋습니다.

![리전 선택](https://osoma.kr/images/posts/ga4-bigquery-connect/13.png)
...
![옵션 선택](https://osoma.kr/images/posts/ga4-bigquery-connect/14.png)

7\. 사용자 데이터 내보내기 기능 사용 여부를 체크합니다. (사용자 데이터 내보내기 체크 시 빅쿼리에 사용자 테이블이 별도로 생성됩니다)

![사용자 내보내기 선택](https://osoma.kr/images/posts/ga4-bigquery-connect/14n.png)

8\. 설정을 검토하고 [보내기] 버튼을 클릭하여 GA4 - 빅쿼리 연결 완료

![연결 완료](https://osoma.kr/images/posts/ga4-bigquery-connect/15n.png)
...
![빅쿼리 리소스](https://osoma.kr/images/posts/ga4-bigquery-connect/16n.png)
...
![빅쿼리 스키마](https://osoma.kr/images/posts/ga4-bigquery-connect/17.png)

데이터가 어떤 형태로 저장되어있는지는 [미리보기]를 통해서 확인할 수 있는데요, GA4가 이벤트 기준으로 데이터를 집계하는 것과 마찬가지로, 빅쿼리에도 이벤트를 기준으로 데이터가 쌓이고 있는 것을 확인할 수 있습니다.

![빅쿼리 미리보기](https://osoma.kr/images/posts/ga4-bigquery-connect/18.png)
...
![스토리지 정보](https://osoma.kr/images/posts/ga4-bigquery-connect/19.png)
...
![데이터 쿼리](https://osoma.kr/images/posts/ga4-bigquery-connect/20.png)

쿼리 실행 후 추출된 결과 데이터는 아래 결과 창을 통해서 확인할 수 있고, 추출된 데이터는 CSV, Google Sheets 외 다양한 형식으로 저장하여 사용할 수 있습니다.

![데이터 내보내기](https://osoma.kr/images/posts/ga4-bigquery-connect/21.png)
...
- [애널리틱스 고객센터 \| [GA4] BigQuery Export](https://support.google.com/analytics/answer/9358801?hl=ko&ref_topic=9359001)
- [Google Cloud \| BigQuery 가격 책정](https://cloud.google.com/bigquery/pricing?hl=ko#storage)
