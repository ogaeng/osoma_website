# 빅쿼리(BigQuery)로 내보낸 구글 서치 콘솔(Search Console) 데이터 활용하기

Source: https://osoma.kr/blog/searchconsole-bigquery-use/
...
먼저 [이전 글](https://osoma.kr/blog/searchconsole-bigquery-export/)을 따라 서치 콘솔 데이터를 빅쿼리로 내보내는 데 성공했다면 아래 이미지처럼 BigQuery Studio에 테이블이 생성된 것을 볼 수 있습니다. 만약 이런 테이블이 없는 경우 [서치 콘솔 데이터를 빅쿼리로 내보내는 작업](https://osoma.kr/blog/searchconsole-bigquery-export/)을 먼저 진행해야 합니다.

![빅쿼리 스튜디오](https://osoma.kr/images/posts/searchconsole-bigquery-use/01.png)
...
![출력 결과 1](https://osoma.kr/images/posts/searchconsole-bigquery-use/02.png)
...
![출력 결과 2](https://osoma.kr/images/posts/searchconsole-bigquery-use/03.png)
...
![출력 결과 3](https://osoma.kr/images/posts/searchconsole-bigquery-use/04.png)
...
![루커 스튜디오 예시](https://osoma.kr/images/posts/searchconsole-bigquery-use/05.png)
