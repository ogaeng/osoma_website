# 빅쿼리(BigQuery) 사용량 확인하기: 리전 및 사용자별 사용량 모니터링

Source: https://osoma.kr/blog/bigquery-monitoring/
...
**`INFORMATION_SCHEMA.JOBS`** 뷰는 여러 스키마를 포함하고 있으며, 여기에서는 몇 가지 주요 스키마에 대해 소개하겠습니다. 더 자세한 스키마 정보는 [BigQuery 공식 문서](https://cloud.google.com/bigquery/docs/information-schema-jobs)를 참조하세요.
...
![구글 클라우드 가격 계산기](https://osoma.kr/images/posts/bigquery-monitoring/01.png)

1. **가격 계산기 접속**: 먼저 [Google Cloud 가격 계산기](https://cloud.google.com/products/calculator)에 접속합니다.
