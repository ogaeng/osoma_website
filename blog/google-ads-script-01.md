...
Source: https://osoma.kr/blog/google-ads-script-01/
...
> 참고 - [구글 애즈 스크립트 웹사이트](https://oso.ma/MuqQk)

조작할 수 있는 항목에는 어떤 것이 있는지 궁금하다면 아래 링크를 참고해주세요.

**조작 가능한 항목 확인하기 -** [Google Ads Entities](https://oso.ma/FQMjK)

**셀렉터 및 메서드 확인하기 -** [Google Ads Selectors](https://oso.ma/bf7gs)
...
![스크립트 메뉴](https://osoma.kr/images/posts/gas-01/1.png)

(+)버튼을 눌러 새 스크립트 작성 작성으로 들어갑니다.

![새 스크립트 작성](https://osoma.kr/images/posts/gas-01/2.png)

노란 띠배너에서 [인증] 버튼을 눌러, 스크립트 실행에 필요한 계정 변경 권한을 부여합니다.

![인증](https://osoma.kr/images/posts/gas-01/3.png)
...
![스크립트 미리보기](https://osoma.kr/images/posts/gas-01/4.png)

![스크립트 인증](https://osoma.kr/images/posts/gas-01/5.png)

한 번 더 [미리보기]버튼을 눌러 로그에 값이 제대로 들어오는 지 확인합니다.

![로그 확인](https://osoma.kr/images/posts/gas-01/6.png)

오류가 발생하지 않았다면 [저장]을 눌러 스크립트를 저장합니다.

![스크립트 저장](https://osoma.kr/images/posts/gas-01/7.png)

이제 스크립트 실행 주기 설정을 위해 [빈도]에 마우스 커서를 가져다 대고 연필 모양 아이콘이 나오면 클릭합니다.

![빈도 선택](https://osoma.kr/images/posts/gas-01/8.png)

체크를 원하는 시간 범위(예: 08시 ~ 09시)를 정하고, 해당 시간에 매일 스크립트가 실행되도록 규칙을 설정합니다.(메일은 항상 정각에 발송되지 않고 지정한 범위 내에 발송됩니다.)

![시간 선택](https://osoma.kr/images/posts/gas-01/9.png)

## 스크립트 실행 결과

미리보기를 실행하면 실행 시간에 바로 메일이 들어오는 것을 확인해 볼 수 있는데요

![발송 결과](https://osoma.kr/images/posts/gas-01/10.png)
