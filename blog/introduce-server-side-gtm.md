# 서버사이드 GTM(Server-side GTM) 소개: 장점과 사례를 바탕으로

Source: https://osoma.kr/blog/introduce-server-side-gtm/
...
![서버사이드 GTM 작동 방식](https://osoma.kr/images/posts/introduce-server-side-gtm/01.png)
...
![서버사이드 GTM 화면](https://osoma.kr/images/posts/introduce-server-side-gtm/02-2.png)
...
<div class="gallery-box">
  <div class="gallery">
    <img src="https://osoma.kr/images/posts/introduce-server-side-gtm/02.png" alt="서버사이드 GTM의 주요 구성 요소">
  </div>
  <em>출처: Google</em>
</div>
...
> [Privacy - Webkit](https://webkit.org/blog/category/privacy/)
...
> [Firestore: NoSQL 문서 데이터베이스 - Google Cloud](https://cloud.google.com/firestore)
...
> [Cloud Run 계산기 \| Google Tag Manager - Server-side](https://developers.google.com/tag-platform/tag-manager/server-side/cloud-run-setup-guide?hl=ko&provisioning=automatic#cloud_run_calculator)
...
![서버 기반의 GA4 추적](https://osoma.kr/images/posts/introduce-server-side-gtm/03.png)
...
![Firestore 연동으로 GA4 데이터 강화](https://osoma.kr/images/posts/introduce-server-side-gtm/04.png)
...
![GA4 데이터를 Amplitude, Mixpanel과 연동](https://osoma.kr/images/posts/introduce-server-side-gtm/05.png)
...
![자동화된 메시지 및 뉴스레터 전송](https://osoma.kr/images/posts/introduce-server-side-gtm/06.png)

알림톡 발송의 경우 오픈소스마케팅에서 만든 템플릿이 있으니 활용해보시는 것을 추천드립니다.

> [카카오톡 알림톡 발송을 위한 Server-side GTM 태그 템플릿 가이드](https://osoma.kr/blog/gtm-template-alimtalk-guide/)
...
![웹훅을 이용한 실시간 주요 행동 알림](https://osoma.kr/images/posts/introduce-server-side-gtm/07.png)
