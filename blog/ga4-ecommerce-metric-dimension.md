...
Source: https://osoma.kr/blog/ga4-ecommerce-metric-dimension/
...
![항목 정보](https://osoma.kr/images/posts/ga4-ecommerce-metric-dimension/01.png)
...
<!-- ![이벤트 코드 도식화](https://osoma.kr/images/posts/ga4-ecommerce-metric-dimension/03.png) -->
<div class="mb-5 text-center">
  <img src="https://osoma.kr/images/posts/ga4-ecommerce-metric-dimension/03.png" width="60%">
</div>
...
> [구글 애널리틱스 4 측정기준과 측정항목의 이해(맞춤 측정기준과 맞춤 측정항목)](https://osoma.kr/blog/ga4-dimension-metrics/)
...
![측정기준 목록](https://osoma.kr/images/posts/ga4-ecommerce-metric-dimension/04.png)
...
이런 부분을 알고 있지 않으면 측정기준 사용 시에 혼란을 겪게 됩니다. [고객 센터 문서](https://support.google.com/analytics/answer/9143382#ecommerce)에도 심지어 실제 GA4 내 적용되어 있는 이름과 번역이 다르게 되어 있어 더 큰 의문을 가져오기도 하죠.
...
![기본 보고서 - 전자상거래 구매](https://osoma.kr/images/posts/ga4-ecommerce-metric-dimension/05.png)
...
![탐색 분석 보고서 - 측정기준 선택](https://osoma.kr/images/posts/ga4-ecommerce-metric-dimension/06.png)
