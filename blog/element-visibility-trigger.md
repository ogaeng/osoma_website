# 구글 태그 매니저(GTM) 요소 공개 상태 트리거 제대로 알아보기

Source: https://osoma.kr/blog/element-visibility-trigger/
...
```html
<img class="lazy" alt="오픈소스마케팅 로고" src="https://osoma.kr/images/logo">
```

이와 같은 특징 때문에 요소 공개 상태 트리거에는 click 트리거처럼 **text 즉 내용을 이용하는 옵션은 존재하지 않습니다.**

![트리거 옵션](https://osoma.kr/images/posts/element-visibility-trigger/01.png)
...
CSS 선택 도구는 위에서 알아본 **HTML 태그, 속성 이름, 속성 값을 활용**하여 우리가 찾고자 하는 **특정 HTML 요소(시작 태그부터 종료 태그까지의 한 묶음)의 위치를 지정**해주는 옵션입니다. id 속성이 없을 때 특정 요소를 지정할 수 있게 구글 태그 매니저에서 제공하는 유일한 대체제입니다. [CSS 선택 도구를 사용하는 규칙](https://www.w3schools.com/cssref/css_selectors.php)은 정해져 있고 그 규칙이 매우 많은데요. 자주 사용하는 규칙을 위주로 알아보도록 하겠습니다.

### 1. 특정 class와 일치하는 경우

```html
<img class="lazy" id="logo" alt="오픈소스마케팅 로고" src="https://osoma.kr/images/logo">
```

![클래스 일치](https://osoma.kr/images/posts/element-visibility-trigger/02.png)
...
![ID 일치](https://osoma.kr/images/posts/element-visibility-trigger/03.png)
...
![요소 일치](https://osoma.kr/images/posts/element-visibility-trigger/04.png)
...
![특정 요소 일치](https://osoma.kr/images/posts/element-visibility-trigger/05.png)
...
![개발자 도구](https://osoma.kr/images/posts/element-visibility-trigger/06.png)
...
![개발자 도구 2](https://osoma.kr/images/posts/element-visibility-trigger/07.png)

### 3. 개발자 도구 내 표시된 위치에서 오른쪽 마우스를 클릭하고 Copy 탭을 눌러 Copy selector를 클릭합니다.

![개발자 도구 3](https://osoma.kr/images/posts/element-visibility-trigger/08.png)
...
![GTM 트리거](https://osoma.kr/images/posts/element-visibility-trigger/09.png)

### 2. 트리거 구성을 눌러 요소 공개 상태 트리거를 클릭합니다.

![트리거 선택](https://osoma.kr/images/posts/element-visibility-trigger/10.png)

### 3. 조건에 맞게 선택 방법을 설정합니다.

![조건 선택](https://osoma.kr/images/posts/element-visibility-trigger/11.png)

### 4. 개발자 도구를 켜서 ID 값 또는 CSS 선택자를 찾아 입력합니다.

![선택자 찾기](https://osoma.kr/images/posts/element-visibility-trigger/12.png)

![선택자 입력](https://osoma.kr/images/posts/element-visibility-trigger/13.png)

CSS 선택자를 복사한 경우 그대로 붙여넣으면 되고 ID 값을 사용하는 경우에는 선택자인 `#` 없이 `ID` 값만 들어가면 되기 때문에 `#`을 붙이지 않도록 주의해주세요.

### 5. 트리거의 실행 시점을 선택합니다.

![실행시점 선택](https://osoma.kr/images/posts/element-visibility-trigger/14.png)
...
![고급 옵션 선택](https://osoma.kr/images/posts/element-visibility-trigger/15.png)
...
![조건 설정](https://osoma.kr/images/posts/element-visibility-trigger/16.png)

### 8. 설정을 완료하였으면 어떤 트리거인지 이해할 수 있게 이름을 정하고 저장합니다.

![저장](https://osoma.kr/images/posts/element-visibility-trigger/17.png)

### 9. 변수 탭으로 넘어가 구성을 클릭합니다.

![구성](https://osoma.kr/images/posts/element-visibility-trigger/18.png)

### 10. 스크롤을 가장 아래로 내려 공개 상태 아래 Percent Visible, On-Screen-Duration을 체크합니다.

![변수 체크](https://osoma.kr/images/posts/element-visibility-trigger/19.png)
...
![태그 새로 만들기](https://osoma.kr/images/posts/element-visibility-trigger/20.png)

### 12. 태그 구성을 눌러 GA4 이벤트 선택 및 입력

![GA4 이벤트 선택](https://osoma.kr/images/posts/element-visibility-trigger/21.png)

### 13. 만든 요소 공개 상태 트리거 용도에 맞게 이벤트 이름을 작성합니다.

![이름 작성](https://osoma.kr/images/posts/element-visibility-trigger/22.png)

### 14. 요소 공개 상태 트리거와 함께 사용할 수 있는 Percent Visible, On-Screen Duration 외 필요한 이벤트 매개변수를 넣어줍니다.

![이벤트 매개변수 작성](https://osoma.kr/images/posts/element-visibility-trigger/23.png)

이벤트와 매개변수가 아직 무엇인지 잘 모르신다면 [구글 애널리틱스 4 이벤트와 매개변수](https://osoma.kr/blog/ga4-event/) 글을 살펴보세요.

### 15. 트리거 box를 클릭하여 기존에 만들어뒀던 요소 공개 상태 트리거를 넣어줍니다.

![트리거 설정](https://osoma.kr/images/posts/element-visibility-trigger/24.png)

### 16. 태그의 설정을 확인하고 이해하기 쉬운 이름으로 태그 이름을 정한 뒤 저장을 누릅니다.

![태그 저장](https://osoma.kr/images/posts/element-visibility-trigger/25.png)
