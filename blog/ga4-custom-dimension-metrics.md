# 구글 애널리틱스 4, 맞춤 측정기준과 맞춤 측정항목의 정의와 사용 방법

Source: https://osoma.kr/blog/ga4-custom-dimension-metrics/
...
![측정기준과 측정항목](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/01-1.png)
...
저희는 이미 다른 포스팅에서 측정기준과 측정항목에 대해 한 번 이야기한 적이 있습니다. 다음의 내용을 더 자세히 알고 싶으시다면 **[구글 애널리틱스 4 측정기준과 측정항목의 이해](https://osoma.kr/blog/ga4-dimension-metrics/)** 포스팅을 참고해 주세요.
...
![이벤트 세팅 사례](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/02.png)
...
![맞춤 정의 화면](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/03.png)
...
![맞춤 측정항목 만들기](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/04.png)
...
![맞춤 정의 추가 시 주의할 점](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/05.png)
...
![기본 보고서 보조 측정기준](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/06.png)
...
![기본 보고서 보조 측정기준 적용 화면](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/07.png)

맞춤 측정항목은 기본 보고서에서 데이터를 구성하는 측정항목으로 등록할 수 있는데, 기본 보고서 우측 상단에 위치한 연필 모양의 아이콘(보고서 맞춤설정)을 누르면 보고서를 편집할 수 있습니다.

![보고서 맞춤 설정 위치](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/08.png)

보고서 편집 화면에서 보고서 데이터의 측정항목을 선택하면 아래와 같이 측정항목의 구성을 변경할 수 있는데 여기에 등록한 맞춤 측정항목을 추가하면 기본 보고서에 맞춤 측정항목이 설정되어 보이게 됩니다.

![보고서 맞춤 설정](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/09.png)

### 탐색 분석 보고서에서의 사용 방법

![탐색 분석 보고서 맞춤 측정기준 카테고리](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/10.png)
...
![탐색 분석 보고서 title 맞춤 측정기준 추가 예시](https://osoma.kr/images/posts/ga4-custom-dimension-metrics/11.png)
