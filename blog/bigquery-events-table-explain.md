# GA4 데이터 분석을 위한 빅쿼리(BigQuery) 스키마(1) - 이벤트(events) 테이블 편

Source: https://osoma.kr/blog/bigquery-events-table-explain/
...
![GA4 데이터를 빅쿼리로 내보내기](https://osoma.kr/images/posts/bigquery-events-table-explain/01.png)
...
![빅쿼리 전체 구조](https://osoma.kr/images/posts/bigquery-events-table-explain/02.png)
...
![빅쿼리 테이블 구조](https://osoma.kr/images/posts/bigquery-events-table-explain/03.png)
...
![빅쿼리 테이블 구조](https://osoma.kr/images/posts/bigquery-events-table-explain/04.png)
...
![빅쿼리 테이블 구조](https://osoma.kr/images/posts/bigquery-events-table-explain/05.png)
...
> [GA4 항목(Item) 범위 맞춤 측정기준 사용하기](https://osoma.kr/blog/ga4-item-custom-dimensions/)
...
> [GA4 데이터 분석을 위한 빅쿼리(BigQuery) 스키마 정리 - 사용자(users) 테이블 편](https://osoma.kr/blog/bigquery-users-table-explain/)
