# 루커 스튜디오 데이터 세트 구성 오류: GA4 API 할당량 이슈

Source: https://osoma.kr/blog/looker-studio-ga-api-quota/
...
지난 1일 동안 이 속성에서 요청이 너무 많이 발생했습니다. [여기](https://developers.google.com/analytics/devguides/reporting/data/v1/quotas)를 클릭하여 요청 할당량에 대해 자세히 알아보거나 Google 애널리틱스 지원팀에 자세한 정보를 문의하세요.<br>
오류 ID: aefdd7e2
...
![루커스튜디오 오류](https://osoma.kr/images/posts/looker-studio-ga-api-quota/01.png)
...
![데이터 커넥터](https://osoma.kr/images/posts/looker-studio-ga-api-quota/02.png)
...
![업데이트](https://osoma.kr/images/posts/looker-studio-ga-api-quota/03.png)
...
![보고서 오류](https://osoma.kr/images/posts/looker-studio-ga-api-quota/04.png)
...
![빅쿼리](https://osoma.kr/images/posts/looker-studio-ga-api-quota/05.png)
...
![빅쿼리 연결](https://osoma.kr/images/posts/looker-studio-ga-api-quota/06.png)

![빅쿼리 연결 2](https://osoma.kr/images/posts/looker-studio-ga-api-quota/07.png)
...
![빅쿼리 연결 쿼리](https://osoma.kr/images/posts/looker-studio-ga-api-quota/08.png)

기본적으로 제공하는 이벤트나 매개변수에 대한 차트 작성에 한계를 느끼는 분들이시라면 직접 쿼리를 작성해서 내가 원하는 기준으로 빅쿼리 데이터를 불러올 수도 있습니다.

![루커 스튜디오 예시](https://osoma.kr/images/posts/looker-studio-ga-api-quota/09.png)
...
[Google Anlaytics Data API Quota](https://developers.google.com/analytics/devguides/reporting/data/v1/quotas)
