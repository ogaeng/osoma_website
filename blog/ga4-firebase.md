# Firebase Analytics와 GA4의 관계 알아보기

Source: https://osoma.kr/blog/ga4-firebase/
...
![Firebase Analytics 대시보드](https://osoma.kr/images/posts/ga4-firebase/01.png)
...
![Firebase의 기능](https://osoma.kr/images/posts/ga4-firebase/02.png)
...
![Firebase Analytics 개요 보고서](https://osoma.kr/images/posts/ga4-firebase/03.png)
...
![프로젝트 추가](https://osoma.kr/images/posts/ga4-firebase/04.png)

**2\. 프로젝트 이름 지정**

규칙에 따라 Firebase에서 사용할 이름을 만들어 주세요. (한글, 특수기호 등 사용 불가)

![프로젝트 이름 지정](https://osoma.kr/images/posts/ga4-firebase/05.png)
...
![GA4 연결](https://osoma.kr/images/posts/ga4-firebase/06.png)
...
![GA4 속성 연결](https://osoma.kr/images/posts/ga4-firebase/07.png)
...
<div class="gallery-box">
  <div class="gallery">
    <img src="https://osoma.kr/images/posts/ga4-firebase/08.png">
    <img src="https://osoma.kr/images/posts/ga4-firebase/09.png">
  </div>
</div>
...
![GA4 계정 선택](https://osoma.kr/images/posts/ga4-firebase/10.png)

**2\. 기존 GA4 계정을 선택합니다. (계정과 속성을 구분하면서 따라해주세요)**

![GA4 계정 선택 2](https://osoma.kr/images/posts/ga4-firebase/11.png)

**3\. 계정을 선택했다면 다음 상황에 따라 맞는 방법을 선택해 진행하세요.**

- 기존 사용하던 GA4 속성이 있다면 연필 아이콘을 눌러 기존 속성을 선택합니다.

![GA4 계정 선택 3](https://osoma.kr/images/posts/ga4-firebase/12.png)

- GA4 속성을 선택한 뒤 Google 애널리틱스 사용 설정 버튼을 눌러 연결을 완료합니다.

![GA4 계정 선택 4](https://osoma.kr/images/posts/ga4-firebase/13.png)
...
![속성 연결 해제](https://osoma.kr/images/posts/ga4-firebase/14.png)
