...
- 스트리밍 내보내기 사용 시 1GB당 $0.05의 추가 비용이 발생합니다.
...
데이터 저장은 매월 10GB까지 무료이며, 이후 데이터는 1GB당 $0.02 과금, 쿼리 사용에는 1달에 1TB까지 무료이며 이후 1TB당 $5의 요금이 부과됩니다.

| 구분 | 무료 사용 범위 | 가격 책정 |
| --- | --- | --- |
| 스토리지 비용 | 10GB (매월) | $0.02/GB |
| 분석 비용(주문형) | 1TB(매월) | $5.00/TB |
