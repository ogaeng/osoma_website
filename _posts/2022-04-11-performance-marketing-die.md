...
![ATT 팝업](/images/posts/performance-marketing-die/01.png)
...
- ATT 도입 시작 기사 ([링크](https://www.cnbc.com/2021/04/20/apple-ios-14point5-release-date-with-att-idfa-restrictions-confirmed-for-next-week.html){:target="_blank"})
- 앱스플라이어가 예상한 초기 ATT 동의율 ([링크](https://www.appsflyer.com/blog/trends-insights/att-opt-in-rates-higher/){:target="_blank"})
- 프리 ATT 프롬프트 관련 정보 ([링크](https://rplg.io/do-s-don-ts-for-an-effective-pre-att-prompt/){:target="_blank"})
- 애플 공식 SKAdNetwork 설명 문서 ([링크](https://developer.apple.com/documentation/storekit/skadnetwork){:target="_blank"})

**섹션2 - 앱광고 매체들이 직면한 문제**

- 애플, 앱 추적 금지하자...타격 입은 페이스북 ([링크](https://www.thedrum.com/news/2021/11/19/marketers-still-scrambling-recover-lost-learnings-facebook-after-apple-privacy-push){:target="_blank"})
- 페이스북의 iOS 14 변경사항 우려 표명 ([링크](https://www.inc.com/jason-aten/facebook-just-admitted-it-has-lost-its-battle-with-apple-over-privacy.html){:target="_blank"})
- ATT 도입한 애플, 작년 광고 매출 238% 폭발적 성장 ([링크](https://www.gov.uk/government/publications/mobile-ecosystems-market-study-interim-report/interim-report){:target="_blank"})
- 애플서치애드는 ATT 영향을 크게 받지 않아 ([링크](https://mobiledevmemo.com/att-advantages-apples-ad-network-heres-how-to-fix-that/){:target="_blank"})

**섹션2  - Apple ITP(지능형 추적 방지) 참고 자료**

- 애플 ITP 정책 ([링크](https://webkit.org/tracking-prevention-policy/){:target="_blank"})
- ITP 1.0 ([링크](https://webkit.org/blog/7675/intelligent-tracking-prevention/){:target="_blank"})
- ITP 2.0 ([링크](https://webkit.org/blog/8311/intelligent-tracking-prevention-2-0/){:target="_blank"})
- ITP 2.1 ([링크](https://webkit.org/blog/8613/intelligent-tracking-prevention-2-1/){:target="_blank"})
- ITP 2.2 ([링크](https://webkit.org/blog/8828/intelligent-tracking-prevention-2-2/){:target="_blank"})
- ITP 2.3 ([링크](https://webkit.org/blog/9521/intelligent-tracking-prevention-2-3/){:target="_blank"})

- Simo Ahava 블로그 \| ITP 2.1 ([링크](https://www.simoahava.com/analytics/itp-2-1-and-web-analytics/){:target="_blank"})
- Ogaeng 블로그 \| GA에서 naver.com/referral은 무엇일까? ([링크](https://ogaeng.com/ga-naver-referral/){:target="_blank"})
- Google Ads Site-wide tag(전체 사이트 태그) ([링크](https://youtu.be/EYVkHhjYMHU?t=161){:target="_blank"})
</div>
</details>
